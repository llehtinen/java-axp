...
public class XPSElementIterator {
	...
	public void accept(XPSVisitor v) throws XPSError{
		try {
	...
	private void accept(XPSVisitor v, ICanvas canvas) throws XPSError {
	...
	private void accept(XPSVisitor v, IGlyphs glyphs) throws XPSError {
	...
	private void accept(XPSVisitor v, IPath path) throws XPSError {
