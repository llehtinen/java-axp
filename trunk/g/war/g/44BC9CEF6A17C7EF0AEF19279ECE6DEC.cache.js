...
function $clinit_29(){
  ...
  TYPE = $DomEvent$Type(new DomEvent$Type(), 'keypress', ($clinit_29() , new KeyPressEvent()));
}
...
function fireClosingImpl(){
  var event_0;
  if (closeHandlersInitialized) {
    event_0 = ($clinit_61() , new Window$ClosingEvent());
    fireEvent(event_0);
    return null;
  }
  return null;
...
function $remove(this$static, w){
  ...
  $setParent(w, null);
  elem = w.element;
  $getParentElement(($clinit_4() , elem)).removeChild(elem);
...
function $VerticalPanel(this$static){
  ...
  this$static.horzAlign = ($clinit_75() , ALIGN_DEFAULT);
...
function remove_1(w){
  var removed, td;
  td = $getParentElement(($clinit_4() , w.element));
  removed = $remove(this, w);
  if (removed) {
...
function $clinit_103(){
  ...
  implWidget = implPanel?($clinit_103() , new FocusImpl()):implPanel;
}
...
function stateUpdated(){
  $setInnerText(($clinit_4() , mInstance.mLabel.element), $wnd.wave.getState().get('text'));
}
...
function $GGadgetImpl(this$static){
  ...
  $setInnerText(($clinit_4() , this$static.mLabel.element), 'Initial Wave State');
  $add_1(vp, this$static.mLabel);
  this$static.mTextBox = $TextBox(new TextBox());
  $add_1(vp, this$static.mTextBox);
  $addDomHandler(this$static.mTextBox, $G$1(new G$1(), this$static), ($clinit_29() , $clinit_29() , TYPE));
  $add(($clinit_88() , get_0(null)), vp);
