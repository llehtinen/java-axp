...
var $strongName = '05DDDDE57F2FF1167EA3C0300A96F6C4';
...
var $intern_0 = '', $intern_6 = '\n', $intern_48 = ' ', $intern_1 = '(', $intern_52 = ', Size: ', $intern_49 = ':', $intern_50 = 'Add not supported on this collection', $intern_44 = 'BUTTON', $intern_39 = 'Cannot set a new parent without first clearing the old parent', $intern_31 = 'DOMMouseScroll', $intern_8 = 'Hello World!', $intern_51 = 'Index: ', $intern_35 = 'MouseEvents', $intern_43 = 'One or more exceptions caught, see full set in AttachDetachException#getCauses', $intern_36 = "Should only call onAttach when the widget is detached from the browser's document", $intern_37 = "Should only call onDetach when the widget is attached to the browser's document", $intern_13 = 'SimpleGadget', $intern_38 = "This widget's parent does not implement HasWidgets", $intern_4 = 'Unknown', $intern_5 = 'Unknown source', $intern_12 = 'alternateburndown.client.AlternateBurndownGadget', $intern_3 = 'anonymous', $intern_14 = 'blur', $intern_45 = 'button', $intern_15 = 'change', $intern_46 = 'className', $intern_7 = 'click', $intern_32 = 'contextmenu', $intern_16 = 'dblclick', $intern_29 = 'error', $intern_17 = 'focus', $intern_2 = 'function', $intern_47 = 'gwt-Button', $intern_34 = 'html', $intern_18 = 'keydown', $intern_19 = 'keypress', $intern_20 = 'keyup', $intern_40 = 'left', $intern_21 = 'load', $intern_22 = 'losecapture', $intern_10 = 'moduleStartup', $intern_23 = 'mousedown', $intern_24 = 'mousemove', $intern_25 = 'mouseout', $intern_26 = 'mouseover', $intern_27 = 'mouseup', $intern_30 = 'mousewheel', $intern_11 = 'onModuleLoadStart', $intern_33 = 'paste', $intern_42 = 'position', $intern_28 = 'scroll', $intern_9 = 'startup', $intern_41 = 'top';
var _;
function nullMethod(){
}
...
function com_google_gwt_lang_EntryMethodHolder_init__V(){
  ...
  !!$stats && $stats({moduleName:$moduleName, sessionId:$sessionId, subSystem:$intern_9, evtGroup:$intern_10, millis:(new Date).getTime(), type:$intern_11, className:$intern_12});
  alternateburndown_client_AlternateBurndownGadget_$init__Lalternateburndown_client_AlternateBurndownGadget_2Lcom_google_gwt_gadgets_client_UserPreferences_2V_simpleButton_0 = com_google_gwt_user_client_ui_Button_$Button__Lcom_google_gwt_user_client_ui_Button_2Ljava_lang_String_2Lcom_google_gwt_user_client_ui_Button_2(new com_google_gwt_user_client_ui_Button, $intern_13);
...
function com_google_gwt_user_client_impl_DOMImplStandard_$initEventSystem__Lcom_google_gwt_user_client_impl_DOMImplStandard_2V(){
  ...
  $wnd.addEventListener($intern_7, com_google_gwt_user_client_impl_DOMImplStandard_dispatchCapturedMouseEvent, true);
  ...
  $wnd.addEventListener($intern_20, com_google_gwt_user_client_impl_DOMImplStandard_dispatchCapturedEvent, true);
...
function com_google_gwt_user_client_impl_DOMImplMozilla_$initSyntheticMouseUpEvents__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2V(){
  $wnd.addEventListener($intern_25, $entry(function(evt){
    var cap = $wnd.__captureElem;
    if (cap && !evt.relatedTarget) {
      if ($intern_34 == evt.target.tagName.toLowerCase()) {
        var muEvent = $doc.createEvent($intern_35);
...
function com_google_gwt_user_client_impl_DOMImplMozilla_$sinkEvents__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2Lcom_google_gwt_user_client_Element_2IV(elem, bits){
  ...
  bits & 131072 && elem.addEventListener($intern_31, com_google_gwt_user_client_impl_DOMImplStandard_dispatchEvent, false);
}
...
function com_google_gwt_user_client_ui_Button_$Button__Lcom_google_gwt_user_client_ui_Button_2Ljava_lang_String_2Lcom_google_gwt_user_client_ui_Button_2(this$static, html){
  ...
  com_google_gwt_user_client_ui_ButtonBase_$ButtonBase__Lcom_google_gwt_user_client_ui_ButtonBase_2Lcom_google_gwt_dom_client_Element_2Lcom_google_gwt_user_client_ui_ButtonBase_2(this$static, (com_google_gwt_user_client_ui_Button_$Button__Lcom_google_gwt_user_client_ui_Button_2Lcom_google_gwt_user_client_ui_Button_2_com_google_gwt_dom_client_Document_$createPushButtonElement__Lcom_google_gwt_dom_client_Document_2Lcom_google_gwt_dom_client_ButtonElement_2_com_google_gwt_dom_client_DOMImpl_$createButtonElement__Lcom_google_gwt_dom_client_DOMImpl_2Lcom_google_gwt_dom_client_Document_2Ljava_lang_String_2Lcom_google_gwt_dom_client_ButtonElement_2_e_0_0_0 = (com_google_gwt_dom_client_DOMImpl_$clinit__V() , $doc).createElement($intern_44) , com_google_gwt_user_client_ui_Button_$Button__Lcom_google_gwt_user_client_ui_Button_2Lcom_google_gwt_user_client_ui_Button_2_com_google_gwt_dom_client_Document_$createPushButtonElement__Lcom_google_gwt_dom_client_Document_2Lcom_google_gwt_dom_client_ButtonElement_2_com_google_gwt_dom_client_DOMImpl_$createButtonElement__Lcom_google_gwt_dom_client_DOMImpl_2Lcom_google_gwt_dom_client_Document_2Ljava_lang_String_2Lcom_google_gwt_dom_client_ButtonElement_2_e_0_0_0.type = $intern_45 , com_google_gwt_user_client_ui_Button_$Button__Lcom_google_gwt_user_client_ui_Button_2Lcom_google_gwt_user_client_ui_Button_2_com_google_gwt_dom_client_Document_$createPushButtonElement__Lcom_google_gwt_dom_client_Document_2Lcom_google_gwt_dom_client_ButtonElement_2_com_google_gwt_dom_client_DOMImpl_$createButtonElement__Lcom_google_gwt_dom_client_DOMImpl_2Lcom_google_gwt_dom_client_Document_2Ljava_lang_String_2Lcom_google_gwt_dom_client_ButtonElement_2_e_0_0_0));
  this$static.com_google_gwt_user_client_ui_UIObject_element[$intern_46] = $intern_47;
...
function java_util_AbstractCollection_add__Ljava_lang_Object_2Z(o){
  throw java_lang_UnsupportedOperationException_$UnsupportedOperationException__Ljava_lang_UnsupportedOperationException_2Ljava_lang_String_2Ljava_lang_UnsupportedOperationException_2(new java_lang_UnsupportedOperationException, $intern_50);
}
...
function java_util_AbstractHashMap_$hasStringValue__Ljava_util_AbstractHashMap_2Ljava_lang_String_2Z(this$static, key){
  return $intern_49 + key in this$static.java_util_AbstractHashMap_stringMap;
}
...
function java_util_AbstractHashMap$MapEntryString_getValue__Ljava_lang_Object_2(){
  return this.java_util_AbstractHashMap$MapEntryString_this$0.java_util_AbstractHashMap_stringMap[$intern_49 + this.java_util_AbstractHashMap$MapEntryString_key];
}
...
function java_util_AbstractList_indexOutOfBounds__IIV(index, size){
  throw java_lang_IndexOutOfBoundsException_$IndexOutOfBoundsException__Ljava_lang_IndexOutOfBoundsException_2Ljava_lang_String_2Ljava_lang_IndexOutOfBoundsException_2(new java_lang_IndexOutOfBoundsException, $intern_51 + index + $intern_52 + size);
}
