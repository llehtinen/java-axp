...
function fireNativeEvent(nativeEvent, handlerSource, relativeElem){
  ...
  if (registered) {
    typeKey = dynamicCast(registered.map[($clinit_5() , nativeEvent).type], 2);
    if (typeKey) {
...
function dispatchEventImpl(evt, elem, listener){
  ...
  if (elem == sCaptureElem) {
    if ($eventGetTypeInt(($clinit_5() , evt).type) == 8192) {
      sCaptureElem = null;
    }
  }
...
function $onBrowserEvent(this$static, event_0){
  var related;
  switch ($eventGetTypeInt(($clinit_5() , event_0).type)) {
    case 16:
    case 32:
...
function $remove(this$static, w){
  ...
  $setParent(w, null);
  elem = w.element;
  $getParentElement(($clinit_5() , elem)).removeChild(elem);
...
function $Label(this$static){
  this$static.element = ($clinit_5() , $doc).createElement('div');
...
function onBrowserEvent(event_0){
  var type;
  type = $eventGetTypeInt(($clinit_5() , event_0).type);
  if ((type & 896) != 0) {
    $onBrowserEvent(this, event_0);
  }
   else {
...
function $TextBox(this$static){
  var e;
  $clinit_97();
  $TextBox_0(this$static, (e = ($clinit_5() , $doc).createElement('INPUT') , e.type = 'text' , e), 'gwt-TextBox');
  return this$static;
}
...
function $VerticalPanel(this$static){
  this$static.children = $WidgetCollection(new WidgetCollection());
  this$static.table = ($clinit_5() , $doc).createElement('table');
...
function $add_1(this$static, w){
  var td_0, tr, td;
  tr = ($clinit_5() , $doc).createElement('tr');
...
function remove_1(w){
  var removed, td;
  td = $getParentElement(($clinit_5() , w.element));
  removed = $remove(this, w);
  if (removed) {
...
function $clinit_104(){
  ...
  implWidget = implPanel?($clinit_104() , new FocusImpl()):implPanel;
}
...
function stateUpdated(){
  $setInnerText(($clinit_5() , mInstance.mLabel.element), $wnd.wave.getState().get('text'));
}
...
function $GGadgetImpl(this$static){
  ...
  $setInnerText(($clinit_5() , this$static.mLabel.element), 'Initial Wave State');
