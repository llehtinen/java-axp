...
var $strongName = '4E0AB5887F750172B8E7964BBD5FD3FF';
...
var $intern_5 = '', $intern_3 = '\n', $intern_45 = ' ', $intern_49 = ', Size: ', $intern_46 = ':', $intern_47 = 'Add not supported on this collection', $intern_41 = 'BUTTON', $intern_36 = 'Cannot set a new parent without first clearing the old parent', $intern_30 = 'DOMMouseScroll', $intern_7 = 'Hello World!', $intern_48 = 'Index: ', $intern_40 = 'One or more exceptions caught, see full set in AttachDetachException#getCauses', $intern_33 = "Should only call onAttach when the widget is detached from the browser's document", $intern_34 = "Should only call onDetach when the widget is attached to the browser's document", $intern_12 = 'SimpleGadget', $intern_35 = "This widget's parent does not implement HasWidgets", $intern_0 = 'Unknown', $intern_1 = 'Unknown source', $intern_11 = 'alternateburndown.client.AlternateBurndownGadget', $intern_2 = 'anonymous', $intern_13 = 'blur', $intern_42 = 'button', $intern_14 = 'change', $intern_43 = 'className', $intern_6 = 'click', $intern_31 = 'contextmenu', $intern_15 = 'dblclick', $intern_28 = 'error', $intern_16 = 'focus', $intern_4 = 'function ', $intern_44 = 'gwt-Button', $intern_17 = 'keydown', $intern_18 = 'keypress', $intern_19 = 'keyup', $intern_37 = 'left', $intern_20 = 'load', $intern_21 = 'losecapture', $intern_9 = 'moduleStartup', $intern_22 = 'mousedown', $intern_23 = 'mousemove', $intern_24 = 'mouseout', $intern_25 = 'mouseover', $intern_26 = 'mouseup', $intern_29 = 'mousewheel', $intern_10 = 'onModuleLoadStart', $intern_32 = 'paste', $intern_39 = 'position', $intern_27 = 'scroll', $intern_8 = 'startup', $intern_38 = 'top';
var _;
function nullMethod(){
}
...
function com_google_gwt_lang_EntryMethodHolder_init__V(){
  ...
  !!$stats && $stats({moduleName:$moduleName, sessionId:$sessionId, subSystem:$intern_8, evtGroup:$intern_9, millis:(new Date).getTime(), type:$intern_10, className:$intern_11});
  alternateburndown_client_AlternateBurndownGadget_$init__Lalternateburndown_client_AlternateBurndownGadget_2Lcom_google_gwt_gadgets_client_UserPreferences_2V_simpleButton_0 = com_google_gwt_user_client_ui_Button_$Button__Lcom_google_gwt_user_client_ui_Button_2Ljava_lang_String_2Lcom_google_gwt_user_client_ui_Button_2(new com_google_gwt_user_client_ui_Button, $intern_12);
...
function com_google_gwt_user_client_impl_DOMImplStandard_$initEventSystem__Lcom_google_gwt_user_client_impl_DOMImplStandard_2V(){
  ...
  $wnd.addEventListener($intern_17, com_google_gwt_user_client_impl_DOMImplStandard_dispatchCapturedEvent, true);
  $wnd.addEventListener($intern_19, com_google_gwt_user_client_impl_DOMImplStandard_dispatchCapturedEvent, true);
  $wnd.addEventListener($intern_18, com_google_gwt_user_client_impl_DOMImplStandard_dispatchCapturedEvent, true);
}
...
function com_google_gwt_user_client_ui_Widget_$onAttach__Lcom_google_gwt_user_client_ui_Widget_2V(this$static){
  ...
  if (this$static.com_google_gwt_user_client_ui_Widget_attached) {
    throw java_lang_IllegalStateException_$IllegalStateException__Ljava_lang_IllegalStateException_2Ljava_lang_String_2Ljava_lang_IllegalStateException_2(new java_lang_IllegalStateException, $intern_33);
  }
...
function com_google_gwt_user_client_ui_Widget_$onDetach__Lcom_google_gwt_user_client_ui_Widget_2V(this$static){
  if (!this$static.com_google_gwt_user_client_ui_Widget_attached) {
    throw java_lang_IllegalStateException_$IllegalStateException__Ljava_lang_IllegalStateException_2Ljava_lang_String_2Ljava_lang_IllegalStateException_2(new java_lang_IllegalStateException, $intern_34);
  }
  try {
...
function com_google_gwt_user_client_ui_Widget_$setParent__Lcom_google_gwt_user_client_ui_Widget_2Lcom_google_gwt_user_client_ui_Widget_2V(this$static, parent){
  ...
  if (!parent) {
    ...
    if (oldParent) {
      throw java_lang_IllegalStateException_$IllegalStateException__Ljava_lang_IllegalStateException_2Ljava_lang_String_2Ljava_lang_IllegalStateException_2(new java_lang_IllegalStateException, $intern_36);
    }
...
function com_google_gwt_user_client_ui_AbsolutePanel_changeToStaticPositioning__Lcom_google_gwt_user_client_Element_2V(elem){
  elem.style[$intern_37] = $intern_5;
  elem.style[$intern_38] = $intern_5;
  elem.style[$intern_39] = $intern_5;
}
...
function com_google_gwt_user_client_ui_Button_$Button__Lcom_google_gwt_user_client_ui_Button_2Ljava_lang_String_2Lcom_google_gwt_user_client_ui_Button_2(this$static, html){
  ...
  com_google_gwt_user_client_ui_ButtonBase_$ButtonBase__Lcom_google_gwt_user_client_ui_ButtonBase_2Lcom_google_gwt_dom_client_Element_2Lcom_google_gwt_user_client_ui_ButtonBase_2(this$static, (com_google_gwt_dom_client_Document_$createPushButtonElement__Lcom_google_gwt_dom_client_Document_2Lcom_google_gwt_dom_client_ButtonElement_2_com_google_gwt_dom_client_DOMImpl_$createButtonElement__Lcom_google_gwt_dom_client_DOMImpl_2Lcom_google_gwt_dom_client_Document_2Ljava_lang_String_2Lcom_google_gwt_dom_client_ButtonElement_2_e_0_0 = (com_google_gwt_dom_client_DOMImpl_$clinit__V() , $doc).createElement($intern_41) , com_google_gwt_dom_client_Document_$createPushButtonElement__Lcom_google_gwt_dom_client_Document_2Lcom_google_gwt_dom_client_ButtonElement_2_com_google_gwt_dom_client_DOMImpl_$createButtonElement__Lcom_google_gwt_dom_client_DOMImpl_2Lcom_google_gwt_dom_client_Document_2Ljava_lang_String_2Lcom_google_gwt_dom_client_ButtonElement_2_e_0_0.type = $intern_42 , com_google_gwt_dom_client_Document_$createPushButtonElement__Lcom_google_gwt_dom_client_Document_2Lcom_google_gwt_dom_client_ButtonElement_2_com_google_gwt_dom_client_DOMImpl_$createButtonElement__Lcom_google_gwt_dom_client_DOMImpl_2Lcom_google_gwt_dom_client_Document_2Ljava_lang_String_2Lcom_google_gwt_dom_client_ButtonElement_2_e_0_0));
  this$static.com_google_gwt_user_client_ui_UIObject_element[$intern_43] = $intern_44;
...
function java_lang_String_$trim__Ljava_lang_String_2Ljava_lang_String_2(this$static){
  if (this$static.length == 0 || this$static[0] > $intern_45 && this$static[this$static.length - 1] > $intern_45) {
    return this$static;
  }
...
function java_util_AbstractCollection_add__Ljava_lang_Object_2Z(o){
  throw java_lang_UnsupportedOperationException_$UnsupportedOperationException__Ljava_lang_UnsupportedOperationException_2Ljava_lang_String_2Ljava_lang_UnsupportedOperationException_2(new java_lang_UnsupportedOperationException, $intern_47);
}
...
function java_util_AbstractHashMap_$get__Ljava_util_AbstractHashMap_2Ljava_lang_Object_2Ljava_lang_Object_2(this$static, key){
  return key == null?this$static.java_util_AbstractHashMap_nullSlot:key != null && com_google_gwt_lang_Cast_canCast__IIZ(key.java_lang_Object_typeId$, 1)?this$static.java_util_AbstractHashMap_stringMap[$intern_46 + com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2ILjava_lang_Object_2(key, 1)]:java_util_AbstractHashMap_$getHashValue__Ljava_util_AbstractHashMap_2Ljava_lang_Object_2ILjava_lang_Object_2(this$static, key, ~~com_google_gwt_core_client_JavaScriptObject_hashCode_1_1devirtual$__Ljava_lang_Object_2I(key));
}
...
function java_util_AbstractHashMap_$hasStringValue__Ljava_util_AbstractHashMap_2Ljava_lang_String_2Z(this$static, key){
  return $intern_46 + key in this$static.java_util_AbstractHashMap_stringMap;
}
...
function java_util_AbstractHashMap$MapEntryString_getValue__Ljava_lang_Object_2(){
  return this.java_util_AbstractHashMap$MapEntryString_this$0.java_util_AbstractHashMap_stringMap[$intern_46 + this.java_util_AbstractHashMap$MapEntryString_key];
}
...
function java_util_AbstractList_indexOutOfBounds__IIV(index, size){
  throw java_lang_IndexOutOfBoundsException_$IndexOutOfBoundsException__Ljava_lang_IndexOutOfBoundsException_2Ljava_lang_String_2Ljava_lang_IndexOutOfBoundsException_2(new java_lang_IndexOutOfBoundsException, $intern_48 + index + $intern_49 + size);
}
