...
var $strongName = 'B0A8DE04AA69177C6A9C28E6CC038325';
...
var $intern_3 = '', $intern_25 = '\n', $intern_67 = ' ', $intern_13 = '&', $intern_4 = ',', $intern_71 = ', Size: ', $intern_15 = '//', $intern_16 = '/jsapi?', $intern_2 = '1', $intern_7 = '127.0.0.1:8080', $intern_29 = ':', $intern_9 = 'ABQIAAAAG8LzhtshQCjpSshU_uJjmxTBfUk9TZrBRaIteybtnU2KziHEpRQvhPNTjo7DMczjrRD3yBPRJ_BSQQ', $intern_8 = 'ABQIAAAAG8LzhtshQCjpSshU_uJjmxTwM0brOpm-All5BF6PoaKBxRWWERTZER2lJ4GnsG8nvhKLOQ20degaEQ', $intern_30 = 'Add not supported on this collection', $intern_69 = 'Add not supported on this list', $intern_62 = 'BUTTON', $intern_57 = 'Cannot set a new parent without first clearing the old parent', $intern_51 = 'DOMMouseScroll', $intern_28 = 'Hello World!', $intern_70 = 'Index: ', $intern_68 = 'Must call next() before remove().', $intern_61 = 'One or more exceptions caught, see full set in AttachDetachException#getCauses', $intern_72 = 'Remove not supported on this list', $intern_54 = "Should only call onAttach when the widget is detached from the browser's document", $intern_55 = "Should only call onDetach when the widget is attached to the browser's document", $intern_1 = 'SimpleGadget', $intern_56 = "This widget's parent does not implement HasWidgets", $intern_22 = 'Unknown', $intern_23 = 'Unknown source', $intern_0 = '_table_query_url', $intern_5 = 'ajaxKeys', $intern_34 = 'alternateburndown.client.AlternateBurndownGadget', $intern_24 = 'anonymous', $intern_35 = 'blur', $intern_63 = 'button', $intern_17 = 'callback=__gwt_AjaxLoader_onLoad', $intern_36 = 'change', $intern_64 = 'className', $intern_27 = 'click', $intern_52 = 'contextmenu', $intern_37 = 'dblclick', $intern_49 = 'error', $intern_38 = 'focus', $intern_26 = 'function ', $intern_20 = 'google', $intern_65 = 'gwt-Button', $intern_11 = 'http:', $intern_10 = 'https:', $intern_12 = 'key=', $intern_39 = 'keydown', $intern_40 = 'keypress', $intern_41 = 'keyup', $intern_58 = 'left', $intern_21 = 'load', $intern_6 = 'localhost:8080', $intern_42 = 'losecapture', $intern_32 = 'moduleStartup', $intern_43 = 'mousedown', $intern_44 = 'mousemove', $intern_45 = 'mouseout', $intern_46 = 'mouseover', $intern_47 = 'mouseup', $intern_50 = 'mousewheel', $intern_33 = 'onModuleLoadStart', $intern_53 = 'paste', $intern_60 = 'position', $intern_18 = 'script', $intern_48 = 'scroll', $intern_31 = 'startup', $intern_19 = 'text/javascript', $intern_59 = 'top', $intern_66 = 'visualization', $intern_14 = 'www.google.com';
var _;
function nullMethod(){
}
...
function com_google_gwt_core_client_impl_StackTraceCreator$CollectorMoz_$inferFrom__Lcom_google_gwt_core_client_impl_StackTraceCreator$CollectorMoz_2Lcom_google_gwt_core_client_JavaScriptObject_2Lcom_google_gwt_core_client_JsArrayString_2(e){
  ...
  for (i = 0 , j = stack.length; i < j; ++i) {
    stack[i] = stack[i].length == 0?$intern_24:stack[i];
  }
  return stack;
}
...
function com_google_gwt_core_client_impl_StackTraceCreator$CollectorOpera_$getStack__Lcom_google_gwt_core_client_impl_StackTraceCreator$CollectorOpera_2Lcom_google_gwt_core_client_JavaScriptObject_2Lcom_google_gwt_core_client_JsArrayString_2(e){
  ...
  toReturn = e && e.message?e.message.split($intern_25):[];
  for (i = 0 , i2 = 0 , j = toReturn.length; i2 < j; ++i , i2 += 2) {
    idx = toReturn[i2].lastIndexOf($intern_26);
...
function com_google_gwt_dom_client_DOMImpl_$setInnerText__Lcom_google_gwt_dom_client_DOMImpl_2Lcom_google_gwt_dom_client_Element_2Ljava_lang_String_2V(elem, text){
...
function com_google_gwt_user_client_ui_AbsolutePanel_changeToStaticPositioning__Lcom_google_gwt_user_client_Element_2V(elem){
  elem.style[$intern_58] = $intern_3;
  elem.style[$intern_59] = $intern_3;
  elem.style[$intern_60] = $intern_3;
}
...
function com_google_gwt_user_client_ui_Button_$Button__Lcom_google_gwt_user_client_ui_Button_2Ljava_lang_String_2Lcom_google_gwt_user_client_ui_Button_2(this$static, html){
  ...
  com_google_gwt_user_client_ui_ButtonBase_$ButtonBase__Lcom_google_gwt_user_client_ui_ButtonBase_2Lcom_google_gwt_dom_client_Element_2Lcom_google_gwt_user_client_ui_ButtonBase_2(this$static, (com_google_gwt_dom_client_Document_$createPushButtonElement__Lcom_google_gwt_dom_client_Document_2Lcom_google_gwt_dom_client_ButtonElement_2_com_google_gwt_dom_client_DOMImpl_$createButtonElement__Lcom_google_gwt_dom_client_DOMImpl_2Lcom_google_gwt_dom_client_Document_2Ljava_lang_String_2Lcom_google_gwt_dom_client_ButtonElement_2_e_0_0 = (com_google_gwt_dom_client_DOMImpl_$clinit__V() , $doc).createElement($intern_62) , com_google_gwt_dom_client_Document_$createPushButtonElement__Lcom_google_gwt_dom_client_Document_2Lcom_google_gwt_dom_client_ButtonElement_2_com_google_gwt_dom_client_DOMImpl_$createButtonElement__Lcom_google_gwt_dom_client_DOMImpl_2Lcom_google_gwt_dom_client_Document_2Ljava_lang_String_2Lcom_google_gwt_dom_client_ButtonElement_2_e_0_0.type = $intern_63 , com_google_gwt_dom_client_Document_$createPushButtonElement__Lcom_google_gwt_dom_client_Document_2Lcom_google_gwt_dom_client_ButtonElement_2_com_google_gwt_dom_client_DOMImpl_$createButtonElement__Lcom_google_gwt_dom_client_DOMImpl_2Lcom_google_gwt_dom_client_Document_2Ljava_lang_String_2Lcom_google_gwt_dom_client_ButtonElement_2_e_0_0));
  this$static.com_google_gwt_user_client_ui_UIObject_element[$intern_64] = $intern_65;
...
function com_google_gwt_visualization_client_VisualizationUtils_loadVisualizationApi__Ljava_lang_String_2Ljava_lang_Runnable_2Lcom_google_gwt_core_client_JsArrayString_2V(version, onLoad, packages){
  ...
  com_google_gwt_ajaxloader_client_AjaxLoader_loadApi__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Runnable_2Lcom_google_gwt_ajaxloader_client_AjaxLoader$AjaxLoaderOptions_2V($intern_66, version, onLoad, options);
}
...
function java_lang_String_$trim__Ljava_lang_String_2Ljava_lang_String_2(this$static){
  if (this$static.length == 0 || this$static[0] > $intern_67 && this$static[this$static.length - 1] > $intern_67) {
    return this$static;
  }
...
function java_util_AbstractHashMap$EntrySetIterator_$remove__Ljava_util_AbstractHashMap$EntrySetIterator_2V(this$static){
  if (!this$static.java_util_AbstractHashMap$EntrySetIterator_last) {
    throw java_lang_IllegalStateException_$IllegalStateException__Ljava_lang_IllegalStateException_2Ljava_lang_String_2Ljava_lang_IllegalStateException_2(new java_lang_IllegalStateException, $intern_68);
  }
   else {
...
function java_util_AbstractList_add__ILjava_lang_Object_2V(index, element){
  throw java_lang_UnsupportedOperationException_$UnsupportedOperationException__Ljava_lang_UnsupportedOperationException_2Ljava_lang_String_2Ljava_lang_UnsupportedOperationException_2(new java_lang_UnsupportedOperationException, $intern_69);
}
...
function java_util_AbstractList_indexOutOfBounds__IIV(index, size){
  throw java_lang_IndexOutOfBoundsException_$IndexOutOfBoundsException__Ljava_lang_IndexOutOfBoundsException_2Ljava_lang_String_2Ljava_lang_IndexOutOfBoundsException_2(new java_lang_IndexOutOfBoundsException, $intern_70 + index + $intern_71 + size);
}
