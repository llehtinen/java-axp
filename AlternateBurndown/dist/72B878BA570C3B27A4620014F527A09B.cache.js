...
var $strongName = '72B878BA570C3B27A4620014F527A09B';
...
var $intern_10 = '', $intern_27 = '\n', $intern_70 = ' ', $intern_12 = '&', $intern_21 = '(', $intern_74 = ', Size: ', $intern_14 = '//', $intern_15 = '/jsapi?', $intern_0 = '1', $intern_5 = '127.0.0.1:8080', $intern_26 = ':', $intern_7 = 'ABQIAAAAG8LzhtshQCjpSshU_uJjmxTBfUk9TZrBRaIteybtnU2KziHEpRQvhPNTjo7DMczjrRD3yBPRJ_BSQQ', $intern_6 = 'ABQIAAAAG8LzhtshQCjpSshU_uJjmxTwM0brOpm-All5BF6PoaKBxRWWERTZER2lJ4GnsG8nvhKLOQ20degaEQ', $intern_32 = 'Add not supported on this collection', $intern_72 = 'Add not supported on this list', $intern_64 = 'BUTTON', $intern_59 = 'Cannot set a new parent without first clearing the old parent', $intern_53 = 'DOMMouseScroll', $intern_31 = 'Hello World!', $intern_73 = 'Index: ', $intern_71 = 'Must call next() before remove().', $intern_63 = 'One or more exceptions caught, see full set in AttachDetachException#getCauses', $intern_75 = 'Remove not supported on this list', $intern_56 = "Should only call onAttach when the widget is detached from the browser's document", $intern_57 = "Should only call onDetach when the widget is attached to the browser's document", $intern_1 = 'SimpleGadget', $intern_58 = "This widget's parent does not implement HasWidgets", $intern_24 = 'Unknown', $intern_25 = 'Unknown source', $intern_29 = '[', $intern_2 = '_table_query_url', $intern_3 = 'ajaxKeys', $intern_36 = 'alternateburndown.client.AlternateBurndownGadget', $intern_23 = 'anonymous', $intern_28 = 'at ', $intern_37 = 'blur', $intern_66 = 'button', $intern_16 = 'callback=__gwt_AjaxLoader_onLoad', $intern_38 = 'change', $intern_67 = 'className', $intern_30 = 'click', $intern_54 = 'contextmenu', $intern_39 = 'dblclick', $intern_51 = 'error', $intern_40 = 'focus', $intern_22 = 'function', $intern_19 = 'google', $intern_68 = 'gwt-Button', $intern_9 = 'http:', $intern_8 = 'https:', $intern_11 = 'key=', $intern_41 = 'keydown', $intern_42 = 'keypress', $intern_43 = 'keyup', $intern_60 = 'left', $intern_20 = 'load', $intern_4 = 'localhost:8080', $intern_44 = 'losecapture', $intern_34 = 'moduleStartup', $intern_45 = 'mousedown', $intern_46 = 'mousemove', $intern_47 = 'mouseout', $intern_48 = 'mouseover', $intern_49 = 'mouseup', $intern_52 = 'mousewheel', $intern_35 = 'onModuleLoadStart', $intern_55 = 'paste', $intern_62 = 'position', $intern_17 = 'script', $intern_50 = 'scroll', $intern_33 = 'startup', $intern_18 = 'text/javascript', $intern_61 = 'top', $intern_65 = 'type', $intern_69 = 'visualization', $intern_13 = 'www.google.com';
var _;
function nullMethod(){
}
...
function com_google_gwt_core_client_impl_StackTraceCreator_extractNameFromToString__Ljava_lang_String_2Ljava_lang_String_2(fnToString){
  ...
  index = fnToString.indexOf($intern_21);
  if (index != -1) {
    start = fnToString.indexOf($intern_22) == 0?8:0;
    toReturn = java_lang_String_$trim__Ljava_lang_String_2Ljava_lang_String_2(fnToString.substr(start, index - start));
  }
  return toReturn.length > 0?toReturn:$intern_23;
}
...
function com_google_gwt_core_client_impl_StackTraceCreator$Collector_$createStackTrace__Lcom_google_gwt_core_client_impl_StackTraceCreator$Collector_2Lcom_google_gwt_core_client_JavaScriptException_2V(this$static, e){
  ...
  for (i = 0 , j = stackTrace.length; i < j; ++i) {
    stackTrace[i] = java_lang_StackTraceElement_$StackTraceElement__Ljava_lang_StackTraceElement_2Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2ILjava_lang_StackTraceElement_2(new java_lang_StackTraceElement, $intern_24, stack[i], $intern_25, 0);
  }
...
function com_google_gwt_core_client_impl_StackTraceCreator$CollectorMoz_$inferFrom__Lcom_google_gwt_core_client_impl_StackTraceCreator$CollectorMoz_2Lcom_google_gwt_core_client_JavaScriptObject_2Lcom_google_gwt_core_client_JsArrayString_2(this$static, e){
  var i, j, stack;
  stack = e && e.stack?e.stack.split($intern_27):[];
...
function com_google_gwt_core_client_impl_StackTraceCreator$CollectorChrome_extractName__Ljava_lang_String_2Ljava_lang_String_2(fnToString){
  ...
  toReturn.indexOf($intern_28) == 0 && (toReturn = toReturn.substr(3, toReturn.length - 3));
  index = toReturn.indexOf($intern_29);
  index == -1 && (index = toReturn.indexOf($intern_21));
  if (index == -1) {
    return $intern_23;
  }
   else {
...
function java_util_AbstractCollection_add__Ljava_lang_Object_2Z(o){
  throw java_lang_UnsupportedOperationException_$UnsupportedOperationException__Ljava_lang_UnsupportedOperationException_2Ljava_lang_String_2Ljava_lang_UnsupportedOperationException_2(new java_lang_UnsupportedOperationException, $intern_32);
}
...
function com_google_gwt_lang_EntryMethodHolder_init__V(){
  !!$stats && $stats({moduleName:$moduleName, sessionId:$sessionId, subSystem:$intern_33, evtGroup:$intern_34, millis:(new Date).getTime(), type:$intern_35, className:$intern_36});
...
function com_google_gwt_user_client_ui_AbsolutePanel_changeToStaticPositioning__Lcom_google_gwt_user_client_Element_2V(elem){
  elem.style[$intern_60] = $intern_10;
  elem.style[$intern_61] = $intern_10;
  elem.style[$intern_62] = $intern_10;
}
